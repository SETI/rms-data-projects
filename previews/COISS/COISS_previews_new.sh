#!/bin/bash
################################################################################
# Create preview images for COISS images, Jupiter and Saturn. This version only
# writes preview images that are missing from the destination directory tree;
# pre-existing preview images are left alone.
#
# Sample usage:
...
do
    ...
    picmaker $volpath/data --replace=none \
