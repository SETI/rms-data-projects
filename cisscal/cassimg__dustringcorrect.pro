...
; MRS temporary fix because GDL read_tiff does not handle a floating-point TIFF correctly
;
;      mottlefile = 'nac_mottle_1444733393.tif'
;      mottle = read_tiff(CalibrationBaseDir + 'dustring/'+mottlefile)

      mottlefile = 'nac_mottle_1444733393.sav'
      restore, CalibrationBaseDir + 'dustring/'+mottlefile
