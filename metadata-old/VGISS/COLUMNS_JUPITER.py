...
RING_TILES = [
    ("where_all", ("where_in_front", PLANET_RING, PLANET),
                  ("where_below", ("ring_radius", PLANET_RING), 226000.)),
    ("where_below",   ("ring_radius", PLANET_RING), 122000.),          # halo
    ("where_between", ("ring_radius", PLANET_RING), 122000., 130000.), # main
    ("where_between", ("ring_radius", PLANET_RING), 130000., 182000.), # Amalthea
    ("where_between", ("ring_radius", PLANET_RING), 182000., 226000.), # Thebe
    ("where_above",   ("ring_radius", PLANET_RING), 226000.)]          # beyond
