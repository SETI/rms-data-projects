################################################################################
# COLUMNS_URANUS.py: Column definitions for Uranus geometry tables
################################################################################
...
RING_TILES = [
    ("where_all",                                   # mask over remaining tiles
        ...
        ("where_below", ("ring_radius", PLANET_RING), 51604.)),
    ("where_between", RING_AZ, 0.15 * np.pi, 0.40 * np.pi),
    ("where_between", RING_AZ, 0.40 * np.pi, 0.60 * np.pi),
    ("where_between", RING_AZ, 0.60 * np.pi, 0.85 * np.pi),
    ("where_between", RING_AZ, 0.85 * np.pi, 1.15 * np.pi),
    ("where_between", RING_AZ, 1.15 * np.pi, 1.40 * np.pi),
    ("where_between", RING_AZ, 1.40 * np.pi, 1.60 * np.pi),
    ("where_between", RING_AZ, 1.60 * np.pi, 1.85 * np.pi),
    ("where_any",
        ("where_below", RING_AZ, 0.15 * np.pi),
        ("where_above", RING_AZ, 1.85 * np.pi)),
]

OUTER_RING_TILES = [
    ("where_all",                                   # mask over remaining tiles
        ("where_in_front", PLANET_RING, PLANET),
        ("where_above", ("ring_radius", PLANET_RING), 51604.)),
    ("where_between", RING_AZ, 0.15 * np.pi, 0.40 * np.pi),
    ("where_between", RING_AZ, 0.40 * np.pi, 0.60 * np.pi),
    ("where_between", RING_AZ, 0.60 * np.pi, 0.85 * np.pi),
    ("where_between", RING_AZ, 0.85 * np.pi, 1.15 * np.pi),
