...
# This is just jnojir_status_index.py renamed
# These are the attributes in the label files...
# DATA_SET_ID
# DATA_SET_NAME
# SPACECRAFT_NAME
...
# Also, these are inside the IMAGE object
#     LINES
#     LINE_SAMPLES
#     SAMPLE_BITS
#     SAMPLE_TYPE
...
# Remove the ones that are already in the INDEX.TAB
# Identify the ones that _always_ contain the same value; we can decide whether to include
# these.
# After we decide, begin adapting this program to JNOSRU.
# Once we have a sample file, you can also edit the template to match.
