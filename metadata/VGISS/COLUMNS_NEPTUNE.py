################################################################################
# COLUMNS_NEPTUNE.py: Column definitions for Neptune geometry tables
################################################################################
...
MOON_NAMES   = [moon.name for moon in moon_bodies] + ['NEREID']
...
RING_TILES = [
    ("where_all", ("where_in_front", PLANET_RING, PLANET),
                  ("where_below", ("ring_radius", PLANET_RING), 63000.)),
    ("where_between", ("ring_radius", PLANET_RING), 40000., 63000.), # rings
]
