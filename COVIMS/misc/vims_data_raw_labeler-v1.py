...
from VERSIONS import VERSIONS_PDS4_VS_PDS3

PDS3_FILEPATHS = {}
VERSIONED_FILEPATHS = set()
for (newname, oldpath) in VERSIONS_PDS4_VS_PDS3:
    PDS3_FILEPATHS[newname] = oldpath
    VERSIONED_FILEPATHS.add(oldpath)
...
for path in paths:
    ...
    line = path[-8:-4]
    if line[0] == '_':
        PDS3_FILEPATHS[sclk + line + '.qub'] = path
    else:
        PDS3_FILEPATHS[sclk + '.qub'] = path
